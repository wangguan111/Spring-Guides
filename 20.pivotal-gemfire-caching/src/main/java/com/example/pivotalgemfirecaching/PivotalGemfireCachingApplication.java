package com.example.pivotalgemfirecaching;
...
public class PivotalGemfireCachingApplication {

    public static void main(String[] args) {
        SpringApplication.run(PivotalGemfireCachingApplication.class, args);
    }
